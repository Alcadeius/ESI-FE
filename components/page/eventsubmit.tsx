...
export default function EventSubmit() {
  ...
  return (
    <div className="bg-[url('/images/DSCF4041-3.png')] bg-center bg-cover h-full lg:px-[80px] lg:py-[56px] 2xl:h-screen before:top-0 before:left-0 w-full bg-no-repeat before:absolute before:z-0 before:content-['a'] before:h-full before:w-full before:bg-black/40">
      <NavigationBar />
      <div className='px-3 md:px-14 md:py-10 lg:px-28 lg:max-w-4xl lg:w-full lg:mx-auto py-5 relative z-10'>
