...
export default function Landing() {
  ...
  return (
   <div className="text-white bg-gradient-to-b lg:px-10 lg:py-10 from-black to to-blue-900/30 lg:h-screen">
    ...
    <div className="flex flex-col lg:grid lg:grid-cols-12 lg:h-3/4 lg:my-auto lg:overflow-hidden lg:mt-10  lg:bg-none bg-[url('/images/DSCF4041-3.png')] md:bg-center lg:before:hidden shadow-xl shadow-black lg:shadow-none  before:content-[''] before:absolute before:w-full before:h-[50vh] before:z-10 before:bg-[#111827] before:opacity-45 before:blur-lg bg-cover bg-no-repeat   place-items-center place-content-center items-center">
    ...
    <div className="font-semibold lg:my-3 text-lg ">
