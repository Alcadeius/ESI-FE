        ...
        <div className="mx-auto w-full lg:h-fit">
          <div className="lg:flex lg:justify-between lg:place-items-start lg:h-full">
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 lg:w-2/3 w-full">
              <div>
                <h2 className="mb-6 font-semibold text-gray-900">Halaman</h2>
              ...
              <div className="order-last lg:order-none col-span-2 lg:col-span-1">
                <h2 className="mb-6 font-semibold">Hubungi Kami</h2>
                <ul className="text-gray-600 dark:text-gray-400">
                  <li className="mb-4">
                    <a href="#" className="hover:underline">esi-denpasar@gmail.com</a>
                  </li>
                  <li>
                    <a href="https://www.instagram.com/esikotadenpasar?igsh=MWpoNTViZDkyZHRtYw==" className="hover:underline">Instagram @esi-dps</a>
                  </li>
                </ul>
              </div>
              <div>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
              ...
              <a href="https://www.instagram.com/esikotadenpasar?igsh=MWpoNTViZDkyZHRtYw==" target="_blank" className="text-gray-500 hover:text-gray-900 ">
