...
export default function Login() {
  ...
  <path fillRule="evenodd" d="M12 1.5a5.25 5.25 0 0 0-5.25 5.25v3a3 3 0 0 0-3 3v6.75a3 3 0 0 0 3 3h10.5a3 3 0 0 0 3-3v-6.75a3 3 0 0 0-3-3v-3c0-2.9-2.35-5.25-5.25-5.25Zm3.75 8.25v-3a3.75 3.75 0 1 0-7.5 0v3h7.5Z" clipRule="evenodd" />
    ...
    <div className='mx-3'>
      <p className='text-xs 2xl:text-lg font-light uppercase'>Belum Memiliki akun? <a href='#' className='uppercase'>Klik Disini</a></p>
    </div>
</form>
</div>  
   ...
   <Image alt='' src="/images/DSCF4041-3.png" width={700} height={700} className='h-[80vh] 2xl:h-[90vh] object-cover w-[100vw]'/>
    ...
    <footer className="text-center py-4 uppercase hidden lg:inline opacity-65 text-xs  xl:absolute xl:left-[40%] xl:translate-x-[10%] xl:bottom-1 2xl:text-2xl bg-transparent">
